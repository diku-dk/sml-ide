...
var t$10363 = appfun2$0dropbox$1.all_files$245;
var t$10362 = c$1637;
var t$10361;
var fix$10335 = {};
...
return appfun2$0dropbox$1.content$303(v$1692,filename$1665,function(c$1687){(smltojs0$0SmlToJsCompApp$1$2.current$1420[0] = filename$1665,0);
...
appfun2$0dropbox$1.write_file$316(v$3819,lname$3810,content$1843,function(v$3820){var v$3821 = v$3820[0];
...
appfun2$0dropbox$1.mkdir$355(v$3868,lname$3859,function(v$3869){var v$3870 = v$3869[0];
...
appfun2$0dropbox$1.delete_file$402(v$4076,v$4054,(function(env$10484){return function(v$4077){var v$10480 = env$10484[0];
...
appfun2$0dropbox$1.delete_dir$460(v$4117,v$4095,(function(env$10497){return function(v$4118){var v$10493 = env$10497[0];
...
return appfun2$0dropbox$1.delete_file$402(v$2029,f$2004,function(v$2027){var v$2028 = v$2027[0];
...
return appfun2$0dropbox$1.write_file$316(v$2079,v$2082,c$2053,function(v$2075){var v$2078 = v$2075[0];
...
appfun2$0dropbox$1.move_file$470(v$2198,filepath$2152,v$2229,function(v$2196){var v$2197 = v$2196[0];
...
if (t$10723) {var c$4928 = appfun2$0dropbox$1.client$79(key$2644);
return appfun2$0dropbox$1.authorize$83(c$4928);
...
return smltojs0$0SmlToJsCompApp$1$2.confirmDialog$2433("Dropbox Sign In","Sign in",msg$2655,function(v$4930){var c$4931 = appfun2$0dropbox$1.client$79(key$2644);
return appfun2$0dropbox$1.authorize$83(c$4931);
});
};
};
...
return smltojs0$0SmlToJsCompApp$1$2.confirmDialog$2433("Dropbox Sign Out","Sign out",msg$2676,function(v$2680){return appfun2$0dropbox$1.signOut$96(c$2667,function(v$2682){(smltojs0$0SmlToJsCompApp$1$2.fileStore$1419[0] = [1],0);
...
v$9098 = (function(c$9103){return v$9102(function(v$9104){var c$9105 = appfun2$0dropbox$1.client$79(v$9101);
if (appfun2$0dropbox$1.isAuthorized$87(c$9105)) {smltojs0$0SmlToJsCompApp$1$2.load$1634(c$9105,fts$2725);
appfun2$0dropbox$1.dropboxUid$200(c$9105,function(uid$9106){var s$9107 = ("Authorized to use " + uid$9106) + "'s Dropbox App Folder";
