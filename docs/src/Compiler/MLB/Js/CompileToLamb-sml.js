...
var v$466 = compiler0$0CompileDec$1$16.compileStrdecs$16067(fe$281,v$338,v$340);
var v$467 = v$466[0];
var v$468 = v$466[1];
...
if (tools$0Flags$1$1.DEBUG_COMPILER$85[0]) {var v$580 = compiler_objects$0LambdaExp$1$4.layoutLambdaPgm$5079(lamb$480);
...
if (tools$0Flags$1$1.DEBUG_COMPILER$85[0]) {var v$590 = compiler_objects$0LambdaExp$1$4.layoutLambdaPgm$5079(v$507);
...
tools$0Timing$1.timing_begin$111(0);
var v$533 = tools$0Timing$1.timing_end_res$270("OptLam",compiler0$0OptLambda$1$14.optimise$19825(v$336,v$325));
var v$534 = v$533[0];
var v$535 = v$533[1];
if (tools$0Flags$1$1.chat$86[0]) {basis$0TextIO$1.output$110(tools$0Flags$1$1.log$101[0],"]\n\n");
tools$0Flags$1$1.log$101[0];
...
if (tools$0Flags$1$1.DEBUG_COMPILER$85[0]?true:(print_opt_lambda_expression$68(0))) {var v$606 = compiler_objects$0LambdaExp$1$4.layoutLambdaPgm$5079(v$534);
...
tools$0Timing$1.timing_begin$111(0);
var env$$551 = tools$0Timing$1.timing_end_res$270("CheckLam",compiler0$0LambdaStatSem$1.type_check$2353(v$334,false,v$322));
if (tools$0Flags$1$1.chat$86[0]) {basis$0TextIO$1.output$110(tools$0Flags$1$1.log$101[0],"]\n\n");
tools$0Flags$1$1.log$101[0];
0;
} else {0;
...
return [1,v$329];
} else {var safe$311 = compiler_objects$0LambdaExp$1$4.safeLambdaPgm$2270(v$322);
