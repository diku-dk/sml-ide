...
var t$291;
var fix$288 = {};
fix$288.$eq_list = function(v$246,v$247){lab$eq_list: while (true) {if (v$246 == null) {return (v$247 == null)?true:false;
} else {if (v$247 == null) {return false;
} else {var v$248 = v$246;
var v$249 = v$247;
if (syntax_objects$0StrId$1.eq_strid$181(v$248[0],v$249[0])) {var t$289 = v$248[1];
var t$290 = v$249[1];
var v$246 = t$289;
var v$247 = t$290;
...
var eq_list$244 = fix$288.$eq_list;
t$291 = (eq_list$244(v$240[0],v$241[0]));
if (t$291) {var v$269 = v$240[1];
var v$270 = v$241[1];
switch (v$270[0]) { case 0: {return v$269[1] == v$270[1];
 break; }default: {return false;
} };
} else {return false;
};
...
var fix$292 = {};
fix$292.$join = function(v$86){if (v$86 == null) {return "";
} else {var v$93 = v$86;
var v$94 = v$93[0];
var v$95 = v$93[1];
return v$94 + (fix$292.$join(v$95));
};
};
var join$83 = fix$292.$join;
return (join$83(string_list$79)) + v$98[1];
};
syntax_objects$0TyCon$1.implode_LongTyCon$99 = function(v$279,v$280){return [0,[v$279,v$280]];
};
...
var v$160 = v$159[0];
var v$161 = v$159[1];
return [0,[basis$0List$1.map$697(function(v$287){return syntax_objects$0StrId$1.mk_StrId$103(v$287);
},basis$0List$1.rev$682(v$161)),[0,v$160]]];
};
};
syntax_objects$0TyCon$1.s$j$162 = function(v$281,v$282){return v$281[1] < v$282[1];
};
...
syntax_objects$0TyCon$1.pu$197 = pickle$0pickle$1.shareGen$878((pickle$0pickle$1.convert0$2299(function(v$285){return [0,v$285];
},function(v$286){return v$286[1];
